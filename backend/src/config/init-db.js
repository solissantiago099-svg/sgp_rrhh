...
const schemaStatements = [
  ...
  `
    ALTER TABLE posicionamientos
    ADD COLUMN IF NOT EXISTS asistencia_estado TEXT NOT NULL DEFAULT 'pendiente';
  `,
  `
    ALTER TABLE posicionamientos
    ADD COLUMN IF NOT EXISTS hora_real_inicio TEXT;
  `,
  `
    ALTER TABLE posicionamientos
    ADD COLUMN IF NOT EXISTS hora_real_fin TEXT;
  `,
  `
    ALTER TABLE posicionamientos
    ADD COLUMN IF NOT EXISTS horas_descontadas NUMERIC(10, 2) NOT NULL DEFAULT 0;
  `,
  `
    ALTER TABLE posicionamientos
    ADD COLUMN IF NOT EXISTS observacion_asistencia TEXT;
  `,
  `
